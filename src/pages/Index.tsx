    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 text-white font-black uppercase tracking-wider"
            >
              МЕНЮ
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-black text-black hover:bg-black hover:text-white font-black uppercase"
            >
              БРОНЬ
            </Button>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {cocktails.map((cocktail, index) => (
              <Card
                key={index}
                className="bg-card border-primary/20 hover:border-primary transition-colors"
              >
                <CardHeader>
            ...
            <Card className="bg-card border-primary/20">
              ...
              <CardContent>
                <p className="mb-6 text-black">
                  Забронируйте столик и окунитесь в атмосферу настоящего
                  рок-бара!
                </p>
                <div className="space-y-4">
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-primary text-primary hover:bg-primary hover:text-white font-black uppercase"
                  >
      ...
      <footer className="py-8 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-sm text-black mt-2">БУНТУЙ. ПЕЙ. ПОЙ РОК. 🤘</p>
        </div>
      </footer>
    </div>
  );
